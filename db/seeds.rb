...
a1 = Anime.create(name: "One Piece", created_date: "1997", synopsis: "Before he was executed, the legendary Pirate King Gold Roger revealed that he had hidden the treasure One Piece somewhere in the Grand Line. Now, many pirates are off looking for this legendary treasure to claim the title Pirate King. One pirate, Monkey D. Luffy, is a boy who had eaten the Devil’s Fruit and gained rubber powers. Now he and his crew are off to find One Piece, while battling enemies and making new friends along the way.", creator: c1)
a2 = Anime.create(name: "Naruto Shippuden", created_date: "1997", synopsis: "Naruto Shippuden is a continuation of original series Naruto. After 2 and a half years of training with his master, Naruto finally returns to his village of Konoha. Naruto is now older and more mature than before. With his new trained ability, his goal of searching for long lost friend, Uchiha Sasuke, is set for a stronger determination than before. He is putting his ambitions to work along with the help of his many friends, though with so many obstacles ahead of him. Now, he will face even more dangerous enemies, especially the Akatsuki.", creator: c2)
a3 = Anime.create(name: "Bleach", created_date: "2001", synopsis: "The story opens with the sudden appearance of Soul Reaper Rukia Kuchiki in Ichigo Kurosaki’s bedroom. Plot: A 15 year-old boy whose name is Kurosaki Ichigo has the ability to see the spirits. The journey begins when Ichigo first meets with Rukia Kuchiki, a Shinigami (in English Soul Reaper). Her mission in the living world is to find evil spirits called Hollow, then eliminate them. When Rukia first meets Ichigo, she finds Ichigo has a tremendous ability in his soul and she thinks he is special. The story continues on with twisted and turns, excitement and sad, friends and foes, and the most important of all, everyone in the series has unique superpower.", creator: c3)
a4 = Anime.create(name: "Dragon Ball Z", created_date: "1989", synopsis: "Goku is back with his new son, Gohan, but just when things are getting settled down, the adventures continue. Whether he is facing enemies such as Frieza, Cell, or Buu, Goku is proven to be an elite of his own and discovers his race, Saiyan and is able to reach Super Saiyan 3 form. He meets many new people, gaining allies and well as enemies, as he still finds time to raise a family and be the happy-go-lucky Saiyan he is.", creator: c4)
a5 = Anime.create(name: "JoJo Bizarre Adventure", created_date: "1987", synopsis: "Beginning its tale in 19th century England, young aristocrat Jonathan Joestar finds himself locked in bitter rivalry with Dio Brando, a low-born boy who Jonathan’s father took under his wing after the death of Dio’s father. Discontent with his station in life, Dio’s fathomless lust to reign over all eventually leads him to seek the supernatural powers of an ancient Aztec stone mask in the Joestar’s possession—an artifact that will forever change the destiny of Dio and Jonathan for generations to come. Fifty years later, in 1938 New York City, Jonathan’s grandson Joseph Joestar must take up his grandfather’s mission and master the abilities necessary to destroy the stone mask and its immensely powerful creators who threaten humanity’s very existence, the Pillar Men.", creator: c5)
a6 = Anime.create(name: "Attack on Titans", created_date: "2009", synopsis: "Several hundred years ago, humans were nearly exterminated by giants. Giants are typically several stories tall, seem to have no intelligence, devour human beings and, worst of all, seem to do it for the pleasure rather than as a food source. A small percentage of humanity survived by enclosing themselves in a city protected by extremely high walls, even taller than the biggest of giants. Flash forward to the present and the city has not seen a giant in over 100 years. Teenage boy Eren and his foster sister Mikasa witness something horrific as the city walls are destroyed by a super giant that appears out of thin air. As the smaller giants flood the city, the two kids watch in horror as their mother is eaten alive. Eren vows that he will murder every single giant and take revenge for all of mankind.", creator: c6)
a7 = Anime.create(name: "One Punch Man", created_date: "2009", synopsis: "The seemingly ordinary and unimpressive Saitama has a rather unique hobby: being a hero. In order to pursue his childhood dream, he trained relentlessly for three years—and lost all of his hair in the process. Now, Saitama is incredibly powerful, so much so that no enemy is able to defeat him in battle. In fact, all it takes to defeat evildoers with just one punch has led to an unexpected problem—he is no longer able to enjoy the thrill of battling and has become quite bored. This all changes with the arrival of Genos, a 19-year-old cyborg, who wishes to be Saitama’s disciple after seeing what he is capable of. Genos proposes that the two join the Hero Association in order to become certified heroes that will be recognized for their positive contributions to society, and Saitama, shocked that no one knows who he is, quickly agrees. And thus begins the story of One Punch Man, an action-comedy that follows an eccentric individual who longs to fight strong enemies that can hopefully give him the excitement he once felt and just maybe, he’ll become popular in the process.", creator: c7)
a8 = Anime.create(name: "Inuyasha", created_date: "1996", synopsis: "Higurashi Kagome, after being pulled down a well by a demon, finds herself in Feudal Japan, where she learns that a powerful jewel has been reborn inside her body. After the jewel shatters in an attempt to retrieve it from one of the many demons who was after its power, Kagome must join forces with the half-demon Inu Yasha (also after the jewel’s power) to track down the shards of the jewel before its power falls into the wrong hands.", creator: c8)
a9 = Anime.create(name: "My Hero Academia", created_date: "2014", synopsis: "What’s a hero? For Izuku Midoriya, the answer to that question has always been simple: “Everything I want to be!” And who is the ultimate hero? Well, the legendary All Might, of course. All Might is the number one ranked hero and also the “Symbol of Peace” in the world. Not in his wildest dreams could Izuku have imagined that he would soon cross paths with his childhood hero…", creator: c9)
a10 = Anime.create(name: "Hunter x Hunter", created_date: "1998", synopsis: "Hunter x Hunter (2011) is set in a world where Hunters exist to perform all manner of dangerous tasks like capturing criminals and bravely searching for lost treasures in uncharted territories. Twelve-year-old Gon Freecss is determined to become the best Hunter possible in hopes of finding his father, who was a Hunter himself and had long ago abandoned his young son. However, Gon soon realizes the path to achieving his goals is far more challenging than he could have ever imagined.", creator: c10) 
a11 = Anime.create(name: "Fullmetal Alchemist: Brotherhood", created_date: "2001", synopsis: "Two brothers lose their mother to an incurable disease. With the power of “alchemy”, they use taboo knowledge to resurrect her. The process fails, and as a toll for using this type of alchemy, the older brother, Edward Elric loses his left leg while the younger brother, Alphonse Elric loses his entire body. To save his brother, Edward sacrifices his right arm and is able to affix his brother’s soul to a suit of armor. With the help of a family friend, Edward receives metal limbs – “automail” – to replace his lost ones. With that, Edward vows to search for the Philosopher’s Stone to return the brothers to their original bodies, even if it means becoming a “State Alchemist”, one who uses his/her alchemy for the military.", creator: c11)
a12 = Anime.create(name: "Akame ga Kill!", created_date: "2010", synopsis: "In a fantasy world, fighter Tatsumi sets out for the Capitol to earn money for his starving village, and finds a world of unimaginable corruption, all spreading from the depraved Prime Minister who controls the child Emperor’s ear. After nearly becoming a victim of this corruption himself, Tatsumi is recruited by Night Raid, a group of assassins dedicated to eliminating the corruption plaguing the Capitol by mercilessly killing those responsible.", creator: c12)
a13 = Anime.create(name: "Sailor Moon", created_date: "1991", synopsis: "Usagi Tsukino is a second-year middle school girl who is a little clumsy and a crybaby, but she is full of energy. One day, she meets Luna, a black cat with a crescent moon on her forehead, and she transforms into Sailor Moon, a sailor-uniformed pretty guardian of love and justice! As a chosen guardian of justice, Usagi seems to have a mission to find the Illusionary Silver Crystal with the other guardians and to protect the princess.", creator: c13)
a14 = Anime.create(name: "Soul Eater", created_date: "2004", synopsis: "Set in the Shinigami technical school for weapon meisters, the series revolves around 3 groups of each a weapon meister and a human weapon. Trying to make the latter a “Death Scythe” and thus fit for use by the Shinigami, they must collect the souls of 99 evil humans and 1 witch. Soul Eater is an anime that centers around meisters and their weapons and their mission to collect 99 evil souls and 1 witch soul. Upon doing that the meister’s weapons will become a Deathscythe, which is the highest title for a weapon. Maka, Soul Eater, Black Star, Tsubaki, Death the Kid, and Patty and Liz Thompson are the characters Soul Eater revolves around. Besides taking the time to gather souls these students of Shibusen defend Death City from some of the most powerful of creatures while still attending school and trying to become stronger", creator: c14)
a15 = Anime.create(name: "Tokyo Ghoul", created_date: "2011", synopsis: "Ken Kaneki is a bookworm college student who meets a girl names Rize at a cafe he frequents. They’re the same age and have the same interests, so they quickly become close. Little does Kaneki know that Rize is a ghoul – a kind of monster that lives by hunting and devouring human flesh. When part of her special organ – “the red child” – is transplanted into Kaneki, he becomes a ghoul himself, trapped in a warped world where humans are not the top of the food chain.", creator: c15)
a16 = Anime.create(name: "No Game No Life", created_date: "2012", synopsis: "Sora and Shiro, a brother and sister whose reputations as brilliant NEET (Not in Education, Employment, or Training) hikikomori (shut-in) gamers have spawned urban legends all over the internet. These two gamers even consider the real world as just another crappy game.", creator: c16)
a17 = Anime.create(name: "Cowboy Bebop", created_date: "1998", synopsis: "Spike Spiegel, a bounty Hunter with a dark past, lives on bounty to bounty, barely making it each time, or not making it at all. His partners Jet Black, Faye Valentine, Ed and Ein the dog all help him in his adventures from planet to planet.", creator: c17)
a18 = Anime.create(name: "Samurai Champloo", created_date: "2004", synopsis: "Mugen is a fierce animal-like warrior with a unique Bboying (break-dance) inspired fighting style. Jin has a more traditional style but don’t think of this as a weakness because his skills are amazing. The two contrasting samurai warriors are far from friends, yet their separate paths seem to cross anyways. Mugen is wandering aimlessly through the city when he stumbles upon a teahouse where he meets Jin and Fuu (A ditzy waitress, but don‘t think she doesn‘t have anything hidden up her sleeves). Fuu convinces them both to come with her in search of a mysterious samurai that smells like sunflowers and their journey begins. This modernized hip-hop tale breaks the barriers of the common, historical, samurai anime.", creator: c18)
a19 = Anime.create(name: "Slam Dunk", created_date: "1990", synopsis: "Sakuragi Hanamichi is a junior high punk used to getting into fights and being rejected by girls but upon entering high school he meets the girl of his dreams, Haruko Akagi. He will do anything in order to win her heart including joining the school basketball team that is aiming to conquer the nation lead by Haruko’s brother. The problem is that Sakuragi has never played basketball before and a freshman sensation is stealing the spotlight and Haruko’s affection from him.", creator: c19)
a20 = Anime.create(name: "Code Geass", created_date: "2006", synopsis: "The Empire of Britannia has invaded Japan using giant robot weapons called Knightmare Frames. Japan is now referred to as Area 11, and its people the 11’s. A Britannian who was living in Japan at the time, Lelouch, vowed to his Japanese friend Suzaku that he’d destroy Britannia. Years later, Lelouch is in high school, but regularly skips out of school to go play chess and gamble on himself. One day, he stumbles on terrorists 11’s who’ve stolen a military secret and is caught by a member of the Britannian task force sent after them, who is Suzaku. As the rest of the squad arrives, Suzaku is shot for disobeying orders, while the military secret, a young girl, gives Lelouch the power of Geass, which makes anyone obey any order. While Suzaku is secretly made the pilot of Britannia’s brand new prototype Knightmare, Lancelot, Lelouch becomes the masked Zero to lead the rebellion to destroy Britannia once and for all.", creator: c20)
a21 = Anime.create(name: "Claymore", created_date: "2001", synopsis: "In a world where humans coexist with sentient monsters called Yoma that feed on human innards, an organization has created an order of half-human, half-yoma warriors to protect humans from the yoma, for a large fee. The people of this world have dubbed these warriors “Claymores” based on their swords. They are also referred to as “Silver Eyed Witches”, based on their appearance and seemingly cold nature toward others. Each Claymore has a rank number which is based on their strength and ability. There are 47 ranks corresponding to the number of regions of the land/world. A Claymore known as Clare saves a small town by killing a Yoma living there, and meets Raki, a boy whose parents were killed by the Yoma. Out of gratitude, Raki ends up following Clare from town to town during her Yoma-killing jobs. The two travel together until they are separated when Clare is forced to battle a sadistic Claymore named Ophelia. Before parting, Clare promises to find him if she survives. The story becomes a tale of revenge, as Clare seeks to confront someone from her past.", creator: c21)
a22 = Anime.create(name: "Elfen Lied", created_date: "2004", synopsis: "The Diclonius, a mutated homo sapien that is said to be selected by God and will eventually become the destruction of mankind, possesses two horns in their heads, and has a “sixth sense” which gives it telekinetic abilities. Due to this dangerous power, they have been captured and isolated in laboratories by the government. Lucy, a young and psychotic Diclonius, manages to break free of her confines and brutally murder most of the guards in the laboratory, only to get shot in the head as she makes her escape. She survives and manages to drift along to a beach, where two teenagers named Kouta and Yuka discovers her. Having lost her memories, she was named after the only thing that she can now say, “Nyuu,” and the two allow her to stay at Kouta’s home. However, it appears that the evil “Lucy” is not dead just yet…", creator: c22)
a23 = Anime.create(name: "Hellsing", created_date: "2001", synopsis: "Hellsing follows the antiheroic vampire, Alucard, and a police girl-turned-vampire, Seras Victoria, two vampires employed by the vampire-extermination group of England, the Hellsing Organization. Slowly but surely, through their active duty, they find a new breed of vampires beginning to arise.", creator: c23)
a24 = Anime.create(name: "Parasyte", created_date: "1989", synopsis: "The 17-year-old Izumi Shinichi lives with his mother and father in a quiet neighborhood in Tokyo. One night, worm-like aliens called Parasytes invade Earth, taking over the brains of human hosts by entering through their ears or noses. One Parasyte attempts to crawl into Shinichi’s ear while he sleeps, but fails since he is wearing headphones, and enters his body by burrowing into his arm instead, taking over his right hand and is named Migi.", creator: c24)
a25 = Anime.create(name: "Death Note", created_date: "2006", synopsis: "Yagami Light is an ace student with great prospects, who’s bored out of his mind. One day he finds the “Death Note”: a notebook from the realm of the Death Gods, with the power to kill people in any way he desires. With the Death Note in hand, Light decides to create his perfect world, without crime or criminals. However, when criminals start dropping dead one by one, the authorites send the legendary detective L to track down the killer, and a battle of wits, deception and logic ensues…", creator: c25)
a26 = Anime.create(name: "Monster", created_date: "1994", synopsis: "Kenzou Tenma, a Japanese brain surgeon in Germany, had it all: incredible skill at his work, a rich and beautiful fiancee, and a promising career at his hospital. However, after becoming disenchanted by hospital politics, he chose to save the life of a young boy who got shot in the head over the life of the mayor. As a result he lost the support of the hospital director, as well as his position in the hospital and his fiance. A short time later, the hospital director and the doctors that replaced him were murdered, and once again he was catapulted back onto the top. But as the chief suspect of the murders, Tenma did not get a easy life. As a matter of fact, it seems that the boy he saved was much more than he had appeared to be… Now to clear his name and to correct his past mistake, Tenma must get to the bottom of these and other murders, and investigate the truth of the Monster who is behind all of this.", creator: c26)
a27 = Anime.create(name: "Ghost in the Shell", created_date: "1989", synopsis: "In the future, life between the digital and physical world has been blurred. The boundary of technology and humanity has been stretched beyond imagination with lives being led in both the electronic and physical worlds. With the melding of man and machine, a new cybernetic level of existence is being created —an existence that continues to redefine mankind.", creator: c27)
a28 = Anime.create(name: "Future Diary", created_date: "2006", synopsis: "Yukiteru Amano (Yuki) is a loner who never really interact with people and prefers writing a diary on his cell phone with his only companion being an imaginary friend named Deus Ex Machina, the God of Time and Space. However, Yuki soon learns that Deus is not a figment of his imagination but real when Deus makes him a participant in a battle royale with eleven others. Within this “Diary Game”, the contestants are given special diaries that can predict the future with each diary having unique features that gives them both advantages and disadvantages.", creator: c28)
a29 = Anime.create(name: "Serial Experiments Lain", created_date: "1998", synopsis: "Lain Iwakura appears to be an ordinary girl, with almost no experience with computers. Yet the sudden suicide of a schoolmate, and a number of strange occurrences, conspire to pull Lain into the world of the Wired, where she gradually learns that nothing is what it seems to be… not even Lain herself.", creator: c29)
a30 = Anime.create(name: "Yu Yu Hakusho", created_date: "1990", synopsis: "One day, 14 year old Yusuke Urameshi suddenly finds himself dead, having died pushing a child out of the way of oncoming traffic. Since he has such a bad personality, even the Spirit World was caught by surpise that he would sacrifice himself. Yusuke soon finds out he wasn’t supposed to die and has a chance for resurrection and bringing his body back to life. After being resurrected, Yusuke becomes a Spirit Detective, along with his comrades, and one adventure after another happens, whether it be an investigation or a fighting tournament.", creator: c10)
a31 = Anime.create(name: "Pokemon", created_date: "1996", synopsis: "A young boy named Ash Ketchum embarks on a journey to become a “Pokemon Master” with his first Pokemon, Pikachu. Joining him on his travels are Brock, a girl-obsessed Rock Pokemon Trainer, and Misty, a tomboyish Water Pokemon Trainer who may have a crush on him. Ash and Co. end up traveling through various regions, including Kanto, the Orange Islands, and Johto, and then enter the Pokemon League competitions there. Along the way, they run into many confrontations with Jessie, James, and Meowth, a trio of Pokemon thieves who are apart of an evil organization called “Team Rocket”. But everytime Team Rocket try to do their evil deeds, they fail thanks to Ash and his Pokemon.", creator: c31)
a32 = Anime.create(name: "Yu-Gi-oh", created_date: "1996", synopsis: "Game loving Mutou Yugi was given an ancient relic by his grandfather called the Sennen (Thousand-Year) Puzzle. He completed the puzzle and was possessed by the spirit of an ancient Pharaoh. The Pharaoh has no memories of who he is or how he got in the puzzle to begin with. The Pharaoh looks out for Yugi and his friends and Yugi agrees to help the Pharaoh recover his lost memory and help him be put to rest so he can go on to the afterlife and finally leave Yugi’s body.", creator: c32)
a33 = Anime.create(name: "Digimon", created_date: "1997", synopsis: "Seven kids are transported to the Digital World, a strange place where digital creatures called “Digimon” reside. A group of Digimon soon befriend them and keep the kids out of harm’s way. The children then become the Digidestined, or Chosen Children, which protect the Digital World from evil Digimon like Devilmon and Myotismon.", creator: c33)
a34 = Anime.create(name: "Afro Summari", created_date: "1998", synopsis: "On the dark path of swordsmanship in a “Futuristic” yet Feudal Japan, it is said that the one who becomes No.1 will rule the world. But the only rule in this world is that only the No. 2 is allowed to fight the No. 1. The No. 2, the Afro Samurai, travels the road looking for revenge on the man who murdered his father in front of him when he was just a boy, a three-armed gunman who is the lord of the dark swordsman’s road and the current No. 1.", creator: c34)
...
char1 = Character.create(name: "Monkey D. Luffy", bio: "Monkey D. Luffy, also known as 'Straw Hat Luffy' and commonly as 'Straw Hat', is the main protagonist of the manga and anime, One Piece. He is the founder and captain of the increasingly infamous and powerful Straw Hat Pirates, as well as one of its top four fighters. His lifelong dream is to become the Pirate King by finding the legendary treasure left behind by the late Pirate King, Gol D. Roger. He believes that being Pirate King means having the most freedom in the world. After his invasion of Totto Land and actions against the Yonko Big Mom, he is currently considered by the global press to be the Fifth Emperor. 
 ...
 Luffy has a worldwide reputation for causing trouble, challenging the Shichibukai, the Marines, and the Yonko.", anime: a1)
...
Moment.create(name: "InuYasha vs. Goshinki", code: "https://www.youtube.com/embed/pT5xCpIaldQ"  , length: "", rating: 5, character: char71)
Moment.create(name: "Birth of Inuyasha", code: "https://www.youtube.com/embed/bO0QD6NoFBY" , length: "", rating: 5, character: char71)
Moment.create(name: "Inuyasha and Kagome Kiss", code: "https://www.youtube.com/embed/NyO_OpiLvew" , length: "", rating: 5, character: char71)
Moment.create(name: "InuYasha vs. Bankotsu", code: "https://www.youtube.com/embed/FSiodK5-iAM" , length: "", rating: 5, character: char71)
Moment.create(name: "Inuyasha Vs Sango", code: "https://www.youtube.com/embed/fEP3IzkSPvA" , length: "", rating: 5, character: char71)

#KAGOME

Moment.create(name: "Kagome and Inuyasha Kiss", code: "https://www.youtube.com/embed/NyO_OpiLvew" , length: "", rating: 5, character: char72)
Moment.create(name: "Kagome Being Fought over by Inuyasha and Koga", code: "https://www.youtube.com/embed/-b77k8SihsM" , length: "", rating: 5, character: char72)
Moment.create(name: "Kagome Hurts Inuyahsa", code: "https://www.youtube.com/embed/fjIu8Yi0UtM" , length: "", rating: 5, character: char72)

#KIKIYO

Moment.create(name: "Kikiyo's Death", code: "https://www.youtube.com/embed/5kKRzYmlIss" , length: "", rating: 5, character: char73)
Moment.create(name: "Kikiyo Meets with Sesshomaru", code: "https://www.youtube.com/embed/yqgfR1ERT7I" , length: "", rating: 5, character: char73)
Moment.create(name: "Kikiyo Saves Rin", code: "https://www.youtube.com/embed/wNED4HlBeoI" , length: "", rating: 5, character: char73)

#Sesshomaru

Moment.create(name: "Sesshomaru Meets with Kikiyo", code: "https://www.youtube.com/embed/yqgfR1ERT7I" , length: "", rating: 5, character: char74)
Moment.create(name: "Sesshomaru and Inuyasha Meet their Father", code: "https://www.youtube.com/embed/pI64qNy08_U" , length: "", rating: 5, character: char74)
Moment.create(name: "Sesshomaru save Kagome from Mukotsu", code: "https://www.youtube.com/embed/cPYF_FqeSCk" , length: "", rating: 5, character: char74)
Moment.create(name: "Sesshomaru saves Kagura", code: "https://www.youtube.com/embed/2Fy-dlnncXI" , length: "", rating: 5, character: char74)

#SANGO

Moment.create(name: "Sango vs Inuyasha", code: "https://www.youtube.com/embed/fEP3IzkSPvA" , length: "", rating: 5, character: char75)
Moment.create(name: "Sango Tries to Kiss Inuyasha", code: "https://www.youtube.com/embed/yQoI_hegIwM"  , length: "", rating: 5, character: char75)
Moment.create(name: "Sango Saved by Miroku", code: "https://www.youtube.com/embed/df8ZIHc2-L8" , length: "", rating: 5, character: char75)

#MIROKU

Moment.create(name: "Miroku Saves Sango", code: "https://www.youtube.com/embed/df8ZIHc2-L8" , length: "", rating: 5, character: char76)
...
Moment.create(name: "Ryuk's story", code: "https://www.youtube.com/embed/sKJk1A-_c9I" , length: "", rating: 5, character: char242)
Moment.create(name: "Ryuk Meets Light", code: "https://www.youtube.com/embed/PWB6Db1y2iw" , length: "", rating: 5, character: char242)
Moment.create(name: "Ryuk Explains the Shinigami Eyes", code: "https://www.youtube.com/embed/tD4XKNm4V4Q" , length: "", rating: 5, character: char242)


#LUFFY

Moment.create(name: "Luffy v Doflamingo", code: "https://www.youtube.com/embed/YYfpWy8T7io", length: "43:52", rating: 5, character: char1)
Moment.create(name: "Luffy vs Rob Lucci", code: "https://www.youtube.com/embed/AXqKcnbbdEw" , length: "55:51", rating: 5, character: char1)
Moment.create(name: "Luffy punches a Celestial Dragon", code: "https://www.youtube.com/embed/GIqz6sBP7Qs", length: "3:15", rating: 5, character: char1)
Moment.create(name: "Luffy vs Captain Kuro", code: "https://www.youtube.com/embed/pIMP93m2418", length: "21:43", rating: 5, character: char1)
Moment.create(name: "Luffy tries to help Nami get well", code: "https://www.youtube.com/embed/LMsRnNpyxAw", length: "1:25", rating: 5, character: char1)
Moment.create(name: "Luffy declaring war on the World Government", code: "https://www.youtube.com/embed/TsP5ByjyU6A", length: "3:45", rating: 5, character: char1)
Moment.create(name: "Luffy gives Name his treasured Strawhat", code: "https://www.youtube.com/embed/dM5tpzY8nFc", length: "2:32", rating: 5, character: char1)
Moment.create(name: "Luffy yells at White Beard", code: "https://www.youtube.com/embed/L-5tolYkK8Q", length: "2:57", rating: 5, character: char1)
Moment.create(name: "Luffy vs the 3 Admirals", code: "https://www.youtube.com/embed/nZNRk5Ix7BU", length: "2:58", rating: 5, character: char1)
Moment.create(name: "Luffy rings OxBell", code: "https://www.youtube.com/embed/KZsYCwuU4QA", length:"2:49", rating: 5, character: char1)
